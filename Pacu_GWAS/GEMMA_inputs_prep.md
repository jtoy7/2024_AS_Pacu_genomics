...
To create these input files, we first need the following:
1. A list of individuals to keep for each analysis (full roster of individuals with complete data, clone-pruned list)
2. 